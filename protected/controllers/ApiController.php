...
class ApiController extends Controller {
    ...
    public function actionView() {
        ...
        if (!isset($_GET['id'])) $this->_sendResponse(500, 'Error: Parameter <b>id</b> is missing');
        ...
        if (is_null($model)) $this->_sendResponse(404, 'No Item found with id ' . $_GET['id']); else
    ...
    public function actionCreate() {
        ...
        if ($model->save()) $this->_sendResponse(200, CJSON::encode($model)); else {
            // Errors occurred
            $msg = "<h1>Error</h1>";
    ...
    public function actionUpdate() {
        ...
        if ($model->save()) $this->_sendResponse(200, CJSON::encode($model)); else
            ...
            // see actionCreate
            // ...
            $this->_sendResponse(500, sprintf('unable update model <b>%s</b>', $_GET['model']));
    }
